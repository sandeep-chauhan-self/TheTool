          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-md border border-white/50 shadow-sm mb-10 animate-fade-in-up">
              ...
              <span className="text-[10px] font-bold tracking-[0.2em] text-slate-500 uppercase">
                System Active • High-Conviction Only
              </span>
            </div>

            <h1
              className="text-6xl lg:text-8xl font-black text-slate-900 tracking-tighter mb-8 animate-fade-in-up"
            ...
            <p
              className="text-xl text-slate-500 max-w-2xl mx-auto mb-12 animate-fade-in-up leading-relaxed"
              style={{ animationDelay: "200ms" }}
            >
              TheTool automates technical analysis by aggregating momentum,
              trend, and volume indicators into high-conviction mandates. Built
              for traders who value data over noise.
            </p>

            <div
              className="flex flex-col sm:flex-row justify-center items-center gap-6 animate-fade-in-up"
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={id}
                  className="p-10 rounded-[2.5rem] bg-white/40 backdrop-blur-sm border border-white hover:bg-white/60 transition-all hover:shadow-xl hover:-translate-y-1 group"
                >
                  <div
                    className={`w-14 h-14 rounded-2xl bg-${item.color}-50 text-${item.color}-500 flex items-center justify-center mb-8 border border-${item.color}-100 shadow-sm group-hover:scale-110 transition-transform`}
                  >
                    {item.icon}
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-24">
              ...
              <p className="text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed">
                Beyond static benchmarks. We are implementing agentic feedback
                loops that evolve with the market.
              </p>
            </div>
            ...
            <div className="relative p-1 px-1 lg:p-12 rounded-[3rem] bg-white/20 backdrop-blur-md border border-white shadow-2xl shadow-primary-500/5">
              <div className="grid lg:grid-cols-3 gap-12 relative z-10 p-8">
                ...
                <div className="space-y-6">
                  <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-10 pl-2">
                    Ingestion Layer
                  </div>
                  ...
                  <div className="p-8 rounded-3xl bg-white border border-slate-100 shadow-sm relative group hover:shadow-lg transition-all">
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed">
                      Real-time OHLCV market streaming via high-throughput
                      webhooks.
                    </p>
                  </div>
                  ...
                  <div className="p-8 rounded-3xl bg-white/40 border-2 border-dashed border-primary-200 shadow-sm relative group grayscale hover:grayscale-0 transition-all">
                    <div className="absolute top-4 right-4 text-[9px] font-black text-primary-500/40 uppercase tracking-tighter">
                      Phase 4
                    </div>
                    <h4 className="font-bold text-slate-900/60 mb-2">
                      Sentiment Engine
                    </h4>
                    <p className="text-xs text-slate-400 leading-relaxed">
                      Multi-modal news and social aggregation for context
                      augmentation.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6 flex flex-col justify-center">
                  <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-10 pl-2 text-center">
                    Processing Engine
                  </div>
                  ...
                  <div className="p-10 rounded-[3rem] bg-gradient-to-br from-white to-slate-50 border border-primary-100 relative shadow-xl shadow-primary-500/10 group overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-xs text-slate-500 leading-relaxed uppercase font-bold tracking-tight mb-4">
                        Continuous Feedback Loop
                      </p>
                      <p className="text-xs text-slate-500 leading-relaxed">
                        LLM-driven agents that dynamically rewrite sub-indicator
                        weights based on prevailing market regimes (Trend vs.
                        Choppy vs. Euphoria).
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-glow-success transition-all duration-500 group">
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed">
                      Single actionable mandates (BUY/SELL/HOLD) with confidence
                      intervals and profit/stop-loss zones.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-5xl mx-auto px-6 relative z-10">
            <div className="bg-white/60 backdrop-blur-md rounded-[4rem] border border-white p-12 lg:p-20 shadow-2xl relative overflow-hidden group">
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                ...
                <h2 className="text-4xl lg:text-5xl font-black text-slate-900 mb-8 tracking-tighter">
                  Redefining Market Analytics.
                </h2>

                <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-12">
                  My name is <b>Sandeep Chauhan</b>. I build high-concurrency
                  architectures that solve real-world SaaS complexities.
                  <br />
                  <br />
                  "TheTool" represents my vision for a zero-emotion trading
                  future. Whether you want to discuss algorithmic strategies,
                  explore high-frequency pipelines,{" "}
                  <b>
                    or offer me a lucrative contract to build your next
                    billion-dollar engine—I’m listening.
                  </b>
                </p>

                <div className="flex flex-wrap justify-center gap-4 mb-20 w-full">
                  <a
                    href="https://wa.me/919625401736"
                    target="_blank"
                    rel="noreferrer"
                    className="flex-1 min-w-[160px] px-8 py-4 bg-[#25D366] text-white font-bold rounded-2xl shadow-lg shadow-success-500/20 hover:-translate-y-1 transition-all text-center"
                  >
                    WhatsApp
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex-1 min-w-[160px] px-8 py-4 bg-[#0A66C2] text-white font-bold rounded-2xl shadow-lg shadow-primary-500/20 hover:-translate-y-1 transition-all text-center"
                  >
                    LinkedIn
                  </a>
                  <a
                    href="tel:+919625401736"
                    className="flex-1 min-w-[160px] px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl shadow-lg shadow-slate-900/20 hover:-translate-y-1 transition-all text-center"
                  >
                    Call Me
                  </a>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-8 text-left w-full mt-10">
                  ...
                  <div className="p-1 w-full bg-gradient-to-br from-primary-200 to-primary-100 rounded-[2.5rem]">
                    <div className="bg-white rounded-[2.4rem] p-8 h-full shadow-sm">
                      <div className="flex justify-between items-start mb-6">
                        <div className="w-10 h-10 bg-primary-50 rounded-xl flex items-center justify-center text-primary-500 border border-primary-100 italic font-black text-lg">
                          P
                        </div>
                        <a
                          href="https://github.com/sandeep-chauhan-self/ThePromptTool"
                          target="_blank"
                          rel="noreferrer"
                      ...
                      <p className="text-sm text-slate-500 leading-relaxed mb-6">
                        An intelligent prompt engineering hub that validates,
                        grades, and enhances your prompts using a complex
                        5-layer rule system. It leverages Claude to transform
                        basic ideas into high-performance AI instructions.
                      </p>
                      <a
                        href="https://the-prompt-tool.vercel.app/"
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center text-xs font-black uppercase text-primary-600 gap-2 border-b-2 border-primary-500 pb-1 hover:text-primary-800 transition-colors"
                      >
                        Live Server
                      </a>
                    </div>
                  ...
                  <div className="p-1 w-full bg-gradient-to-br from-accent-200 to-accent-100 rounded-[2.5rem]">
                    <div className="bg-white rounded-[2.4rem] p-8 h-full shadow-sm">
                      <div className="flex justify-between items-start mb-6">
                        <div className="w-10 h-10 bg-accent-50 rounded-xl flex items-center justify-center text-accent-500 border border-accent-100 italic font-black text-lg">
                          T
                        </div>
                        <a
                          href="https://github.com/sandeep-chauhan-self/TheTool"
                          target="_blank"
                          rel="noreferrer"
                          className="text-slate-400 hover:text-slate-900 transition-colors"
                        >
                      ...
                      <p className="text-sm text-slate-500 leading-relaxed mb-6">
                        A robust stock analysis and monitoring infrastructure
                        that processes real-time NSE data across large asset
                        universes. It evaluates high-conviction mandates using
                        advanced technical models to provide traders with
                        data-driven edge.
                      </p>
                      <a
                        href="https://the-tool-theta.vercel.app/"
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center text-xs font-black uppercase text-accent-600 gap-2 border-b-2 border-accent-500 pb-1 hover:text-accent-800 transition-colors"
                      >
                        Live Server
                      </a>
                    </div>
